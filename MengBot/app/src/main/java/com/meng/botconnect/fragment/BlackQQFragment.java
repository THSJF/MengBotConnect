                            ...
                            public void onClick(DialogInterface p11, int p2) {
                                new AlertDialog.Builder(getActivity())
									...
									.setPositiveButton("确定", new DialogInterface.OnClickListener() {
										@Override
										public void onClick(DialogInterface p11, int p2) {
											MainActivity2.instance.CQ.send(BotDataPack.encode(BotDataPack.removeBlackQQ).write(number));
											MainActivity2.instance.CQ.send(BotDataPack.encode(BotDataPack.addBlackQQ).write(Long.parseLong(editText.getText().toString())));
										}
					...
					new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                ...
                                MainActivity2.instance.CQ.send(BotDataPack.encode(BotDataPack.removeBlackQQ).write(qq));
                            }
                        }).setNegativeButton("取消", null).show();
					return true;
				}
                                ...
                                new AlertDialog.Builder(getActivity())
									...
									.setPositiveButton("确定", new DialogInterface.OnClickListener() {
										...
										public void onClick(DialogInterface p11, int p2) {
											...
											for (long l : MainActivity2.instance.botData.ranConfig.blackListQQ) {
												if (l == userInput) {
													return;
												}
											}
