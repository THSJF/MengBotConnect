...
import com.meng.grzxConfig.MaterialDesign.view.*;
import java.io.*;
import java.net.*;
...
public class InfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im.setImageBitmap(BitmapFactory.decodeFile(MainActivity2.mainFolder + "bilibili/" + intent.getStringExtra("bid") + ".jpg"));
        l1.addView(im);
